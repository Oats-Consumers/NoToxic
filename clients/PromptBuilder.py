...
Answer with one word only: Yes or No."""
    ...
    class LabelDataPrompt:
        def build_label_data_prompt(self, entry):
            ...
            ⚠️ Important: Even short or ambiguous messages (like "?", "b", or "xD") can be TOXIC if the surrounding context suggests sarcasm, provocation, or ridicule.

            Use the full context provided — including game state, hero performance, and recent chat — to make a well-informed judgment.

            Below are several examples of labeled chat messages. Use these as a guide to understand what constitutes a TOXIC or NON-TOXIC label.
            ...
            Classify the message based on the context above. Respond with a single word: TOXIC or NON-TOXIC.
            """.strip()
